...
WINDRES   = windres.exe
# OBJS      = main.o menu.o data_struct.o utility.o \
...
# 			menu_bignum.o
# LINKOBJS  = main.o menu.o data_struct.o utility.o \
# 			mbr.o gpt.o fat.o evp.o file.o serial.o file_ksoc_array_generation.o \
# 			string_match.o menu_string_match.o\
# 			list.o menu_list.o\
# 			c_test.o menu_c_test.o \
...
# fw_exp.o: fw_exp.C
# 	$(CC) -c fw_exp.c $(BFLAGS) fw_exp.o $(CFLAGS)

# ftl_bt_mics.o: ftl_bt_mics.c ftl_bt_mics.h
# 	$(CC) -c ftl_bt_mics.c $(BFLAGS) ftl_bt_mics.o $(CFLAGS)