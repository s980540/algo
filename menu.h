...
// ret_code menu_opt_init(int argc, char **argv, int i, const menu_option_t *menu_options);
...
ret_code menu_func_help(const char *func_name, const menu_option_t *menu_options);
void menu_opt_help(const char *func_name, const menu_option_t *menu_options2);
ret_code menu_opt_process(int argc, char **argv, const char *func_name, const menu_option_t *menu_options);
